...
contract Ownable {
    ...
    modifier isValidAddress(address potentialOwner){
      require(potentialOwner != address(0), "The address is not valid.");
      _;
    }
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(to != _tokenOwner[tokenId], "This token already belongs to the provided address");

        // require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        require(msg.sender == getOwner() || isApprovedForAll(msg.sender, to), "Caller is not the owner of the contract or got approval for all tokens");
